...
console.log('Test web3.eth.getUncle.')
...
var block = web3.eth.getUncle(blockNumber, 0);
...
var block = web3.eth.getUncle(blockNumber, 0, true);
...
var block = web3.eth.getUncle(blockHash, 0);
...
var block = web3.eth.getUncle(blockHash, 0, true);
